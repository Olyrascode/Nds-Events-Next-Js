...
// import { Container, Paper, Typography, Box, Divider, Grid, Button, Alert } from '@mui/material';
...
//   const orderId = searchParams.get('id'); // Récupère l'ID depuis l'URL
...
//           setOrder(data.order); // Assurez-vous de récupérer le bon champ, ici data.order
//         } catch (err) {
...
//           <Box key={item._id || item.id} sx={{ mb: 2 }}>
