  ...
  return (
    ...
    >
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={2} sx={{ p: 3, height: "100%" }}>
            ...
            <TextField
              ...
              value={product.lotSize || ""}
              onChange={(e) =>
                setProduct({ ...product, lotSize: e.target.value })
              }
              margin="normal"
              inputProps={{ min: 1 }}
              disabled={loading}
            ...
            {/* Aperçu des calculs de prix - Plus compact */}
            {product.price && product.price > 0 && (
              <Paper
                elevation={1}
                sx={{
                ...
                {(() => {
                  ...
                  return (
                    ...
                    >
                      <Typography variant="body2">
                        <strong>HT :</strong>{" "}
                        {formatPrice(calculations.priceHT)}
                      </Typography>
                      <Typography variant="body2">
                        <strong>TVA :</strong>{" "}
                        {formatPrice(calculations.vatAmount)}
        ...
        {/* Section 4: Options et Variations */}
        <Grid item xs={12}>
          <Paper elevation={2} sx={{ p: 3 }}>
            <Typography
              variant="h6"
            ...
            {/* Case livraison obligatoire - MAINTENANT EN PREMIER */}
            <FormControlLabel
              control={
                <Checkbox
                  checked={product.deliveryMandatory}
                  onChange={(e) =>
                    setProduct({
                      ...product,
                      deliveryMandatory: e.target.checked,
                    })
                  }
                  disabled={loading}
                />
            ...
            {/* Case à cocher pour les variations - MAINTENANT EN DESSOUS */}
            <FormControlLabel
              control={
                <Checkbox
                  checked={product.hasVariations}
        ...
        {/* Section 5: Associations Catégories */}
            ...
            <Box sx={{ mb: 2 }}>
              {product.associations.map((assoc, index) => (
                <Chip
                  ...
                  onDelete={() => handleRemoveAssociation(index)}
                  sx={{ mr: 1, mb: 1 }}
                  disabled={loading}
                />
              ))}
                    ...
                    return (
                      <Box key={uniqueKey}>
                        ...
                        {index === 0 &&
                          option === "➕ Créer une nouvelle catégorie..." && (
                            <Box
                              sx={{ borderBottom: "1px solid #e0e0e0", mx: 1 }}
                            />
                          )}
                      </Box>
                    );
